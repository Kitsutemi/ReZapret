...
set "GITHUB_DOWNLOAD_URL=https://github.com/Kitsutemi/ReZapret/releases/download/latest/zapret-discord-youtube-"
...
set "hostsUrl=https://raw.githubusercontent.com/Kitsutemi/ReZapret/refs/heads/main/.service/hosts.txt"
